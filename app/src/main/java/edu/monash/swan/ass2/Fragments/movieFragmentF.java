 ...
 */
public class movieFragmentF extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_movie_f, container, false);

        pref = this.getActivity().getSharedPreferences("admin", getActivity().getApplicationContext().MODE_PRIVATE);
        //获取SharedPreferences.Editor对象
        editor = pref.edit();
        String fovuriteMovie = pref.getString("FovuriteMovie", "this is default value");
